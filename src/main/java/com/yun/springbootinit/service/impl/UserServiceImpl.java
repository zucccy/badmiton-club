...
import com.yun.springbootinit.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "chenyun";

    @Override
    public long userRegister(String account, String userPassword, String checkPassword) {
        // 1. 校验
        if (StringUtils.isAnyBlank(account, userPassword, checkPassword)) {
    ...
    public boolean isAdmin(User user) {
        return ObjectUtils.isNotEmpty(user) && UserRoleEnum.ADMIN.getValue().equals(user.getRole());
    }
